...
namespace Gegl {
	...
	public class Node : GLib.Object {
		...
		public void get_property (string property_name, out GLib.Value value);
	...
	public enum CachePolicy {
		[CCode (cname = "GEGL_CACHE_POLICY_AUTO")]
		AUTO,
		[CCode (cname = "GEGL_CACHE_POLICY_NEVER")]
		NEVER,
		[CCode (cname = "GEGL_CACHE_POLICY_ALWAYS")]
		ALWAYS
	}
